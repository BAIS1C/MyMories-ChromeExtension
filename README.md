...
- **💬 Multi-Platform Support**: Extract conversations from **9 platforms** including ChatGPT, Claude, Gemini, Grok, DeepSeek, Perplexity, Kimi, Z.ai, and Poe
...
4. **If updating:** Click "Remove" on the old version of MyMories.
5. Click "Load unpacked" and select the extension folder.
6. **Important:** Refresh your AI chat tabs (ChatGPT, Claude, etc.) for the new script to load.
...
### Supported Platforms (Updated v1.1.1)
...
- **Z.ai (ChatGLM)** (chat.z.ai, chatglm.cn)
- **Poe** (poe.com) - Limited support
